...
$jumlahSiswa2 = count($nilaiSiswa);

echo "<br><br> Nilai siswa: " . implode(", ", $nilaiSiswa) . "<br>";
echo "Jumlah Siswa: $jumlahSiswa2 <br>";
echo "Jumlah siswa lulus: $siswaLulus <br>";
echo "Jumlah siswa tidak lulus: $siswaTidakLulus <br>";
?>